...
file <- "mm_up4.rds"  #pick a file to load and make a point shapefile 
...
writeOGR(spdf, "C://Users//ealab//Documents//ArcGIS//AMAPPS//shp_from_R", layer= str_c("XY", filename), driver="ESRI Shapefile", verbose=TRUE)
